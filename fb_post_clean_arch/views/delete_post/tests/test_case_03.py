...
class TestCase03DeletePostAPITestCase(CustomTestUtils):
    app_name = APP_NAME
    ...
    def setupUser(self, username, password):
        super(TestCase03DeletePostAPITestCase, self).setupUser(
            username=username, password=password
        )
        user_objs = UserFactory.create_batch(5)
        PostFactory(user=user_objs[4])
